  ...
  const tips = [
    {
      ...
      description: t('tips.tip1.description')
    },
    {
      icon: MessageSquare,
      title: t('tips.tip2.title'),
      description: t('tips.tip2.description')
    },
    {
      icon: CheckCircle,
      title: t('tips.tip3.title'),
      description: t('tips.tip3.description')
    }
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              {t('steps.title')} <span className="gradient-accent bg-clip-text text-transparent">{t('steps.titleHighlight')}</span>
            </h2>
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">
              {t('tips.title')} <span className="gradient-primary bg-clip-text text-transparent">{t('tips.titleHighlight')}</span>
            </h2>
            <p className="text-xl text-muted-foreground">
              {t('tips.subtitle')}
            </p>
