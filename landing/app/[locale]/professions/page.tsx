...
// Professions data moved inline to avoid import issues
...
export default function ProfessionsPage() {
  ...
  const professions = [
    ...
    { key: "qa", icon: TestTube },
    { key: "uxui", icon: Palette },
    { key: "dataAnalyst", icon: BarChart },
    { key: "dataScientist", icon: BarChart3 },
    { key: "productManager", icon: Users }
  ];
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {professions.map((profession, index) => {
              ...
              return (
                <Card 
                  key={index} 
                  className="neu-card border-0 hover:glow-secondary transition-all duration-300 hover:scale-105 cursor-pointer"
