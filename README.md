...
- [ ] Карточки "Стать кандидатом / Стать интервьюером" с статистикой (queuedRequests, scheduledMatches)
- [ ] Отдельный блок "Выгодно сейчас": расчёт по очереди/доходу
- [ ] Свободный выбор → записать в профиль
...
- [ ] Кнопки "Пожаловаться", "Позвать модератора" внутри сессии
- [ ] Планирование мобильной адаптации основных экранов (слоты, чеклист, чат)
- [ ] Логики выбора платёжной системы по стране (см. README TODO)
...
3. **Pro** - $20/3 месяца (популярный)
   ...
   [] возможность в админке дабавлять платежные системы в засисимости от страны
